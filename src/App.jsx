    ...
    <div className="rules-panel info-panel-static">
      ...
      <div className="info-body">
        ...
        <p>
          ...
          최악 창 -9.3%로 뒤집힙니다.
          {' '}<b>검증(23창 기준)</b> — 끄기 대비 평균 <b>+18.0%</b>, 블록 95% 신뢰구간 [1.5, 40.0],
          23창 중 11개 개선·11개 차이 없음·악화 1개. 전체 구간은 552.8억 → 1521.9억(+175.3%)로
          ...
          합성 11창은 3개뿐이고, 독립 5창에서는 3/5입니다(닷컴 -1.6%, 금융위기 +0.0%, 2009~2014 +17.2%).
